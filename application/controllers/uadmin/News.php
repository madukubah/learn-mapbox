...
class News extends Uadmin_Controller {
	private $services = null;
    private $name = null;
    private $parent_page = 'uadmin';
	private $current_page = 'uadmin/news/';
	...
	public function index()
	{
		...
		$table[ "rows" ] = $this->news_model->newss( $pagination['start_record'], $pagination['limit_per_page'] )->result();
	...
	public function add(  )
	{
        ...
        {
          $this->data['message'] = (validation_errors() ? validation_errors() : ($this->m_account->errors() ? $this->news_model->errors() : $this->session->flashdata('message')));
          if(  validation_errors() || $this->news_model->errors() ) $this->session->set_flashdata('alert', $this->alert->set_alert( Alert::DANGER, $this->data['message'] ) );
		}
