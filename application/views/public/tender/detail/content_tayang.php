...
<div class="content-wrapper" style="height:100%; background: #f15f79;
      ...
      <div class="card card-outline card-outline-tabs">
        <div class="card-header p-0 border-bottom-0">
          ...
          <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link" id="custom-tabs-four-profile-tab" data-toggle="pill" href="#custom-tabs-four-profile" role="tab" aria-controls="custom-tabs-three-profile" aria-selected="false">Penyedia (Pemenang)</a>
            </li>
          </ul>
        </div>
        <div class="card-body">
